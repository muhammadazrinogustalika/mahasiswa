            ...
            >
                ...
                <div class="flex items-center justify-center py-4 px-6 border-b border-gray-700">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-semibold text-white">Data Mahasiswa</span>
                    </a>
                </div>
                ...
                <nav class="mt-4">
                    ...
                    <a href="{{ route('namakeluarga.index') }}" class="flex items-center mt-2 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:text-white">
                        ...
                        <span class="mx-3">Data Keluarga</span>
                    </a>
                    ...
                    <a href="{{ route('mahasiswanama.index') }}" class="flex items-center mt-2 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:text-white">
                        ...
                        <span class="mx-3">Nama Mahasiswa</span>
                    </a>
                </nav>
            </aside>
